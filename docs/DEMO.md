...
1. **Chat**: Send messages in English, Hindi, or Hinglish
2. **Knowledge**: Browse policy documents, test retrieval
3. **Voice**: Upload audio for transcription (mock STT)
4. **Channels**: Simulate email/WhatsApp events
5. **Evaluations**: Run eval suite, view results
6. **Auth**: Register, login, manage sessions
